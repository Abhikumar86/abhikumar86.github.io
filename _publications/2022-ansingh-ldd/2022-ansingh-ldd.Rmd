...
The primary aim of this paper was to investigate the effects of species and origin on coal mine spoil restoration. Among the spoil physical properties, soil texture parameters (clay, silt and sand content) was significantly differed due to species (Table \@ref(tab:tab1)). However, bulk density, pH and water holding capacity were found similar under all species plantations (Table \@ref(tab:tab1)).
