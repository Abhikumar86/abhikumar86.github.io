...
```{r fig.cap="Figure from http://haryanaforest.gov.in/Portals/0/morni-sanctuary.jpg", layout = "l-body", out.extra="class=external", out.width="100%"}
knitr::include_graphics("data/morni-sanctuary.jpg")
```


```{r fig.cap="Figure from https://parivesh.nic.in/writereaddata/ENV/Eco-sensitiveZone/16.pdf", layout = "l-body", out.extra="class=external", out.width="100%"}
knitr::include_graphics("data/mwls-notification.pdf")
```


```{r fig.cap="Figure from http://moef.gov.in/wp-content/uploads/2019/10/Map-of-ESZ-of-Khol-Hi-Ratan-WLS-Haryana.pdf", layout = "l-body", out.extra="class=external", out.width="100%"}
knitr::include_graphics("data/mwls-esz.pdf")
```


* http://haryanaforest.gov.in/en-us/Wild-Life/Protected-Area
